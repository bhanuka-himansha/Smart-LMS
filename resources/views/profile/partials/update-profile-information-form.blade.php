<div class="w-full p-6 bg-white rounded-lg shadow dark:bg-gray-800">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Make sure your account info stays current and correct.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="epfno" :value="__('EPF No')" />
            <x-text-input id="epfno" name="epfno" type="text" class="mt-1 block w-full" :value="old('epfno', $user->epfno)"
                required autofocus autocomplete="epfno" />
            <x-input-error class="mt-2" :messages="$errors->get('epfno')" />
        </div>
