...
<div id="toast-default"
    class=" fixed top-16 right-4 z-50 flex items-center w-full max-w-xs p-4 text-{{ $colour }}-500 bg-white rounded-lg shadow dark:text-{{ $colour }}-400 dark:bg-gray-800 border border-{{ $colour }}-500 "
    role="alert">
    <div
...
<script>
    function showAlert() {
        ...
        // Set timeout to auto-close the alert after 30 seconds
        setTimeout(() => {
            hideAlert();
        }, 10000);
    }
